...
public final class Constantes {
	...
	DNI,
	/**
	 * Error caracteres extra�os a UTF8.
	 */
	UTF8,
	/**
    ...
    /**
     * Min edad allowed.
     * v2.0 eliminado límite de edad inferior.
     */
    public static final int MIN_EDAD = 0;
    
    /**
     * Max edad allowed.
     * v2.0 eliminado limite de edad superior.
     */
    public static final int MAX_EDAD = 100000;
    ...
    /**
     * String para cumplimentar el tama�o del dni.
     */
    public static final String DNI_CARACTER = "0";
    
    /**
     * Tama�o m�nimo del DNI (se rellenar� con DNI_CARACTER).
     */
