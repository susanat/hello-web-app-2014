...
public final class Output {
	...
	//Nos aseguramos que no sea null para que no falle en el proceso de write
	if (aLines == null) {
	...
	aLines.add("L�neas Totales: " + objAction.getCountLines());
	aLines.add("L�neas Correctas: " + lineasCorrectas);
	aLines.add("L�neas con alg�n fallo: " + lineasInCorrectas);  	    
	...
	aLines.add("N�mero de duplicados: " + duplicados);
	...
	//TODO: sacar todo de aqu� y crear las estad�sitcas en otra funci�n a parte para poder acceder a ellas
