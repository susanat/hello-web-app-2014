...
public class Constantes {
	...
	// Servlet
	public static final String CONTROLLER_AGENDA = "PersonaServlet";
	public static final String JSP_LISTADO = "Listado.jsp";
	public static final String JSP_DETALLE = "Detalle.jsp";
